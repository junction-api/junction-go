...
var (
	getOrderTrackingLabTestsRequestFieldOrderId = big.NewInt(1 << 0)
)

type GetOrderTrackingLabTestsRequest struct {
	// Your Order ID.
	OrderId string `json:"-" url:"-"`
...
func (g *GetOrderTrackingLabTestsRequest) require(field *big.Int) {
	if g.explicitFields == nil {
		g.explicitFields = big.NewInt(0)
	}
	g.explicitFields.Or(g.explicitFields, field)
...
// SetOrderId sets the OrderId field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (g *GetOrderTrackingLabTestsRequest) SetOrderId(orderId string) {
	g.OrderId = orderId
	g.require(getOrderTrackingLabTestsRequestFieldOrderId)
}
...
// ℹ️ This enum is non-exhaustive.
type CollectionInferenceSource string

const (
	CollectionInferenceSourceLabArrival           CollectionInferenceSource = "lab_arrival"
	CollectionInferenceSourceLabAccessioning      CollectionInferenceSource = "lab_accessioning"
	CollectionInferenceSourceScheduledAppointment CollectionInferenceSource = "scheduled_appointment"
	CollectionInferenceSourceDispatchDate         CollectionInferenceSource = "dispatch_date"
)

func NewCollectionInferenceSourceFromString(s string) (CollectionInferenceSource, error) {
	switch s {
	case "lab_arrival":
		return CollectionInferenceSourceLabArrival, nil
	case "lab_accessioning":
		return CollectionInferenceSourceLabAccessioning, nil
	case "scheduled_appointment":
		return CollectionInferenceSourceScheduledAppointment, nil
	case "dispatch_date":
		return CollectionInferenceSourceDispatchDate, nil
	}
	var t CollectionInferenceSource
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (c CollectionInferenceSource) Ptr() *CollectionInferenceSource {
	return &c
}
...
// ℹ️ This enum is non-exhaustive.
type EtaUpdateSource string

const (
	EtaUpdateSourceLab      EtaUpdateSource = "lab"
	EtaUpdateSourceJunction EtaUpdateSource = "junction"
	EtaUpdateSourcePatient  EtaUpdateSource = "patient"
)

func NewEtaUpdateSourceFromString(s string) (EtaUpdateSource, error) {
	switch s {
	case "lab":
		return EtaUpdateSourceLab, nil
	case "junction":
		return EtaUpdateSourceJunction, nil
	case "patient":
		return EtaUpdateSourcePatient, nil
	}
	var t EtaUpdateSource
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (e EtaUpdateSource) Ptr() *EtaUpdateSource {
	return &e
}
...
// ℹ️ This enum is non-exhaustive.
type OrderMarkerTrackingStatus string

const (
	OrderMarkerTrackingStatusPending    OrderMarkerTrackingStatus = "pending"
	OrderMarkerTrackingStatusIncomplete OrderMarkerTrackingStatus = "incomplete"
	OrderMarkerTrackingStatusResulted   OrderMarkerTrackingStatus = "resulted"
)

func NewOrderMarkerTrackingStatusFromString(s string) (OrderMarkerTrackingStatus, error) {
	switch s {
	case "pending":
		return OrderMarkerTrackingStatusPending, nil
	case "incomplete":
		return OrderMarkerTrackingStatusIncomplete, nil
	case "resulted":
		return OrderMarkerTrackingStatusResulted, nil
	}
	var t OrderMarkerTrackingStatus
	return "", fmt.Errorf("%s is not a valid %T", s, t)
}

func (o OrderMarkerTrackingStatus) Ptr() *OrderMarkerTrackingStatus {
	return &o
}
...
var (
	orderTrackingFieldOrderId     = big.NewInt(1 << 0)
	orderTrackingFieldExpectedAt  = big.NewInt(1 << 1)
	orderTrackingFieldCollectedAt = big.NewInt(1 << 2)
	orderTrackingFieldMarkers     = big.NewInt(1 << 3)
	orderTrackingFieldUpdates     = big.NewInt(1 << 4)
)

type OrderTracking struct {
	OrderId     string                   `json:"order_id" url:"order_id"`
	ExpectedAt  *OrderTrackingExpectedAt `json:"expected_at" url:"expected_at"`
	CollectedAt *OrderTrackingCollection `json:"collected_at,omitempty" url:"collected_at,omitempty"`
	Markers     []*OrderTrackingMarker   `json:"markers" url:"markers"`
	Updates     []*OrderTrackingUpdate   `json:"updates" url:"updates"`
...
func (o *OrderTracking) GetOrderId() string {
	if o == nil {
		return ""
	}
	return o.OrderId
...
func (o *OrderTracking) GetExpectedAt() *OrderTrackingExpectedAt {
	if o == nil {
		return nil
	}
	return o.ExpectedAt
...
func (o *OrderTracking) GetCollectedAt() *OrderTrackingCollection {
	if o == nil {
		return nil
	}
...
func (o *OrderTracking) GetMarkers() []*OrderTrackingMarker {
	if o == nil {
		return nil
	}
	return o.Markers
...
func (o *OrderTracking) GetUpdates() []*OrderTrackingUpdate {
	if o == nil {
		return nil
	}
	return o.Updates
...
func (o *OrderTracking) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTracking) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetOrderId sets the OrderId field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTracking) SetOrderId(orderId string) {
	o.OrderId = orderId
	o.require(orderTrackingFieldOrderId)
}

// SetExpectedAt sets the ExpectedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTracking) SetExpectedAt(expectedAt *OrderTrackingExpectedAt) {
	o.ExpectedAt = expectedAt
	o.require(orderTrackingFieldExpectedAt)
}

// SetCollectedAt sets the CollectedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTracking) SetCollectedAt(collectedAt *OrderTrackingCollection) {
	o.CollectedAt = collectedAt
	o.require(orderTrackingFieldCollectedAt)
}

// SetMarkers sets the Markers field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTracking) SetMarkers(markers []*OrderTrackingMarker) {
	o.Markers = markers
	o.require(orderTrackingFieldMarkers)
}

// SetUpdates sets the Updates field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTracking) SetUpdates(updates []*OrderTrackingUpdate) {
	o.Updates = updates
	o.require(orderTrackingFieldUpdates)
}

func (o *OrderTracking) UnmarshalJSON(data []byte) error {
	type unmarshaler OrderTracking
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*o = OrderTracking(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTracking) MarshalJSON() ([]byte, error) {
	type embed OrderTracking
	var marshaler = struct {
		embed
	}{
		embed: embed(*o),
...
func (o *OrderTracking) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingCollectionFieldCollectedAt  = big.NewInt(1 << 0)
	orderTrackingCollectionFieldIsInferred   = big.NewInt(1 << 1)
	orderTrackingCollectionFieldInferredFrom = big.NewInt(1 << 2)
)

type OrderTrackingCollection struct {
	CollectedAt time.Time `json:"collected_at" url:"collected_at"`
	IsInferred  bool      `json:"is_inferred" url:"is_inferred"`
	// ℹ️ This enum is non-exhaustive.
	InferredFrom *CollectionInferenceSource `json:"inferred_from,omitempty" url:"inferred_from,omitempty"`
...
func (o *OrderTrackingCollection) GetCollectedAt() time.Time {
	if o == nil {
		return time.Time{}
	}
	return o.CollectedAt
...
func (o *OrderTrackingCollection) GetIsInferred() bool {
	if o == nil {
		return false
	}
	return o.IsInferred
...
func (o *OrderTrackingCollection) GetInferredFrom() *CollectionInferenceSource {
	if o == nil {
		return nil
	}
...
func (o *OrderTrackingCollection) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingCollection) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetCollectedAt sets the CollectedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingCollection) SetCollectedAt(collectedAt time.Time) {
	o.CollectedAt = collectedAt
	o.require(orderTrackingCollectionFieldCollectedAt)
}

// SetIsInferred sets the IsInferred field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingCollection) SetIsInferred(isInferred bool) {
	o.IsInferred = isInferred
	o.require(orderTrackingCollectionFieldIsInferred)
}

// SetInferredFrom sets the InferredFrom field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingCollection) SetInferredFrom(inferredFrom *CollectionInferenceSource) {
	o.InferredFrom = inferredFrom
	o.require(orderTrackingCollectionFieldInferredFrom)
}

func (o *OrderTrackingCollection) UnmarshalJSON(data []byte) error {
	type embed OrderTrackingCollection
	var unmarshaler = struct {
		embed
		CollectedAt *internal.DateTime `json:"collected_at"`
	}{
		embed: embed(*o),
	}
	if err := json.Unmarshal(data, &unmarshaler); err != nil {
	...
	*o = OrderTrackingCollection(unmarshaler.embed)
	o.CollectedAt = unmarshaler.CollectedAt.Time()
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingCollection) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingCollection
	var marshaler = struct {
		embed
		CollectedAt *internal.DateTime `json:"collected_at"`
		...
		embed:       embed(*o),
		CollectedAt: internal.NewDateTime(o.CollectedAt),
	}
	explicitMarshaler := internal.HandleExplicitFields(marshaler, o.explicitFields)
	return json.Marshal(explicitMarshaler)
}

func (o *OrderTrackingCollection) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingEstimateFieldOriginalEstimate = big.NewInt(1 << 0)
	orderTrackingEstimateFieldCurrentEstimate  = big.NewInt(1 << 1)
)

type OrderTrackingEstimate struct {
	OriginalEstimate *time.Time `json:"original_estimate,omitempty" url:"original_estimate,omitempty"`
	CurrentEstimate  *time.Time `json:"current_estimate,omitempty" url:"current_estimate,omitempty"`
...
func (o *OrderTrackingEstimate) GetOriginalEstimate() *time.Time {
	if o == nil {
		return nil
	}
...
func (o *OrderTrackingEstimate) GetCurrentEstimate() *time.Time {
	if o == nil {
		return nil
	}
...
func (o *OrderTrackingEstimate) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingEstimate) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetOriginalEstimate sets the OriginalEstimate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingEstimate) SetOriginalEstimate(originalEstimate *time.Time) {
	o.OriginalEstimate = originalEstimate
	o.require(orderTrackingEstimateFieldOriginalEstimate)
}

// SetCurrentEstimate sets the CurrentEstimate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingEstimate) SetCurrentEstimate(currentEstimate *time.Time) {
	o.CurrentEstimate = currentEstimate
	o.require(orderTrackingEstimateFieldCurrentEstimate)
}

func (o *OrderTrackingEstimate) UnmarshalJSON(data []byte) error {
	type embed OrderTrackingEstimate
	var unmarshaler = struct {
		embed
		OriginalEstimate *internal.DateTime `json:"original_estimate,omitempty"`
		CurrentEstimate  *internal.DateTime `json:"current_estimate,omitempty"`
	}{
		embed: embed(*o),
	}
	if err := json.Unmarshal(data, &unmarshaler); err != nil {
	...
	*o = OrderTrackingEstimate(unmarshaler.embed)
	o.OriginalEstimate = unmarshaler.OriginalEstimate.TimePtr()
	o.CurrentEstimate = unmarshaler.CurrentEstimate.TimePtr()
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingEstimate) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingEstimate
	var marshaler = struct {
		embed
		OriginalEstimate *internal.DateTime `json:"original_estimate,omitempty"`
		...
		embed:            embed(*o),
		OriginalEstimate: internal.NewOptionalDateTime(o.OriginalEstimate),
		CurrentEstimate:  internal.NewOptionalDateTime(o.CurrentEstimate),
	}
	explicitMarshaler := internal.HandleExplicitFields(marshaler, o.explicitFields)
	return json.Marshal(explicitMarshaler)
}

func (o *OrderTrackingEstimate) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingExpectedAtFieldFinalResults = big.NewInt(1 << 0)
)

type OrderTrackingExpectedAt struct {
	FinalResults *OrderTrackingEstimate `json:"final_results" url:"final_results"`
...
func (o *OrderTrackingExpectedAt) GetFinalResults() *OrderTrackingEstimate {
	if o == nil {
		return nil
	}
	return o.FinalResults
}

func (o *OrderTrackingExpectedAt) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingExpectedAt) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetFinalResults sets the FinalResults field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingExpectedAt) SetFinalResults(finalResults *OrderTrackingEstimate) {
	o.FinalResults = finalResults
	o.require(orderTrackingExpectedAtFieldFinalResults)
}

func (o *OrderTrackingExpectedAt) UnmarshalJSON(data []byte) error {
	type unmarshaler OrderTrackingExpectedAt
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*o = OrderTrackingExpectedAt(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingExpectedAt) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingExpectedAt
	var marshaler = struct {
		embed
	}{
		embed: embed(*o),
...
func (o *OrderTrackingExpectedAt) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingImpactedMarkerFieldId         = big.NewInt(1 << 0)
	orderTrackingImpactedMarkerFieldName       = big.NewInt(1 << 1)
	orderTrackingImpactedMarkerFieldProviderId = big.NewInt(1 << 2)
	orderTrackingImpactedMarkerFieldEstimates  = big.NewInt(1 << 3)
)

type OrderTrackingImpactedMarker struct {
	Id         int                    `json:"id" url:"id"`
	Name       string                 `json:"name" url:"name"`
	ProviderId *string                `json:"provider_id,omitempty" url:"provider_id,omitempty"`
	Estimates  *OrderTrackingEstimate `json:"estimates" url:"estimates"`
...
func (o *OrderTrackingImpactedMarker) GetId() int {
	if o == nil {
		return 0
	}
	return o.Id
...
func (o *OrderTrackingImpactedMarker) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *OrderTrackingImpactedMarker) GetProviderId() *string {
	if o == nil {
		return nil
	}
	return o.ProviderId
...
func (o *OrderTrackingImpactedMarker) GetEstimates() *OrderTrackingEstimate {
	if o == nil {
		return nil
	}
	return o.Estimates
...
func (o *OrderTrackingImpactedMarker) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingImpactedMarker) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetId sets the Id field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingImpactedMarker) SetId(id int) {
	o.Id = id
	o.require(orderTrackingImpactedMarkerFieldId)
}

// SetName sets the Name field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingImpactedMarker) SetName(name string) {
	o.Name = name
	o.require(orderTrackingImpactedMarkerFieldName)
}

// SetProviderId sets the ProviderId field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingImpactedMarker) SetProviderId(providerId *string) {
	o.ProviderId = providerId
	o.require(orderTrackingImpactedMarkerFieldProviderId)
}

// SetEstimates sets the Estimates field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingImpactedMarker) SetEstimates(estimates *OrderTrackingEstimate) {
	o.Estimates = estimates
	o.require(orderTrackingImpactedMarkerFieldEstimates)
}

func (o *OrderTrackingImpactedMarker) UnmarshalJSON(data []byte) error {
	type unmarshaler OrderTrackingImpactedMarker
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*o = OrderTrackingImpactedMarker(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingImpactedMarker) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingImpactedMarker
	var marshaler = struct {
		embed
	}{
		embed: embed(*o),
...
func (o *OrderTrackingImpactedMarker) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingMarkerFieldId         = big.NewInt(1 << 0)
	orderTrackingMarkerFieldName       = big.NewInt(1 << 1)
	orderTrackingMarkerFieldSlug       = big.NewInt(1 << 2)
	orderTrackingMarkerFieldProviderId = big.NewInt(1 << 3)
	orderTrackingMarkerFieldStatus     = big.NewInt(1 << 4)
	orderTrackingMarkerFieldExpectedAt = big.NewInt(1 << 5)
	orderTrackingMarkerFieldResults    = big.NewInt(1 << 6)
)

type OrderTrackingMarker struct {
	Id         int     `json:"id" url:"id"`
	Name       string  `json:"name" url:"name"`
	Slug       string  `json:"slug" url:"slug"`
	ProviderId *string `json:"provider_id,omitempty" url:"provider_id,omitempty"`
	// ℹ️ This enum is non-exhaustive.
	Status     OrderMarkerTrackingStatus    `json:"status" url:"status"`
	ExpectedAt *OrderTrackingEstimate       `json:"expected_at" url:"expected_at"`
	Results    []*OrderTrackingResultMarker `json:"results" url:"results"`
...
func (o *OrderTrackingMarker) GetId() int {
	if o == nil {
		return 0
	}
	return o.Id
...
func (o *OrderTrackingMarker) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *OrderTrackingMarker) GetSlug() string {
	if o == nil {
		return ""
	}
	return o.Slug
...
func (o *OrderTrackingMarker) GetProviderId() *string {
	if o == nil {
		return nil
	}
	return o.ProviderId
...
func (o *OrderTrackingMarker) GetStatus() OrderMarkerTrackingStatus {
	if o == nil {
		return ""
	}
	return o.Status
...
func (o *OrderTrackingMarker) GetExpectedAt() *OrderTrackingEstimate {
	if o == nil {
		return nil
	}
	return o.ExpectedAt
...
func (o *OrderTrackingMarker) GetResults() []*OrderTrackingResultMarker {
	if o == nil {
		return nil
	}
	return o.Results
...
func (o *OrderTrackingMarker) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingMarker) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetId sets the Id field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetId(id int) {
	o.Id = id
	o.require(orderTrackingMarkerFieldId)
}

// SetName sets the Name field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetName(name string) {
	o.Name = name
	o.require(orderTrackingMarkerFieldName)
}

// SetSlug sets the Slug field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetSlug(slug string) {
	o.Slug = slug
	o.require(orderTrackingMarkerFieldSlug)
}

// SetProviderId sets the ProviderId field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetProviderId(providerId *string) {
	o.ProviderId = providerId
	o.require(orderTrackingMarkerFieldProviderId)
}

// SetStatus sets the Status field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetStatus(status OrderMarkerTrackingStatus) {
	o.Status = status
	o.require(orderTrackingMarkerFieldStatus)
}

// SetExpectedAt sets the ExpectedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetExpectedAt(expectedAt *OrderTrackingEstimate) {
	o.ExpectedAt = expectedAt
	o.require(orderTrackingMarkerFieldExpectedAt)
}

// SetResults sets the Results field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingMarker) SetResults(results []*OrderTrackingResultMarker) {
	o.Results = results
	o.require(orderTrackingMarkerFieldResults)
}

func (o *OrderTrackingMarker) UnmarshalJSON(data []byte) error {
	type unmarshaler OrderTrackingMarker
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*o = OrderTrackingMarker(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingMarker) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingMarker
	var marshaler = struct {
		embed
	}{
		embed: embed(*o),
...
func (o *OrderTrackingMarker) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingResultMarkerFieldId         = big.NewInt(1 << 0)
	orderTrackingResultMarkerFieldName       = big.NewInt(1 << 1)
	orderTrackingResultMarkerFieldSlug       = big.NewInt(1 << 2)
	orderTrackingResultMarkerFieldProviderId = big.NewInt(1 << 3)
)

type OrderTrackingResultMarker struct {
...
func (o *OrderTrackingResultMarker) GetId() *int {
	if o == nil {
		return nil
	}
	return o.Id
...
func (o *OrderTrackingResultMarker) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *OrderTrackingResultMarker) GetSlug() string {
	if o == nil {
		return ""
	}
	return o.Slug
...
func (o *OrderTrackingResultMarker) GetProviderId() *string {
	if o == nil {
		return nil
	}
	return o.ProviderId
...
func (o *OrderTrackingResultMarker) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingResultMarker) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetId sets the Id field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingResultMarker) SetId(id *int) {
	o.Id = id
	o.require(orderTrackingResultMarkerFieldId)
}

// SetName sets the Name field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingResultMarker) SetName(name string) {
	o.Name = name
	o.require(orderTrackingResultMarkerFieldName)
}

// SetSlug sets the Slug field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingResultMarker) SetSlug(slug string) {
	o.Slug = slug
	o.require(orderTrackingResultMarkerFieldSlug)
}

// SetProviderId sets the ProviderId field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingResultMarker) SetProviderId(providerId *string) {
	o.ProviderId = providerId
	o.require(orderTrackingResultMarkerFieldProviderId)
}

func (o *OrderTrackingResultMarker) UnmarshalJSON(data []byte) error {
	type unmarshaler OrderTrackingResultMarker
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*o = OrderTrackingResultMarker(value)
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingResultMarker) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingResultMarker
	var marshaler = struct {
		embed
	}{
		embed: embed(*o),
...
func (o *OrderTrackingResultMarker) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
...
var (
	orderTrackingUpdateFieldCreatedAt       = big.NewInt(1 << 0)
	orderTrackingUpdateFieldReason          = big.NewInt(1 << 1)
	orderTrackingUpdateFieldRevisedEstimate = big.NewInt(1 << 2)
	orderTrackingUpdateFieldImpactedMarkers = big.NewInt(1 << 3)
	orderTrackingUpdateFieldSource          = big.NewInt(1 << 4)
)

type OrderTrackingUpdate struct {
	CreatedAt       time.Time                      `json:"created_at" url:"created_at"`
	Reason          *string                        `json:"reason,omitempty" url:"reason,omitempty"`
	RevisedEstimate *time.Time                     `json:"revised_estimate,omitempty" url:"revised_estimate,omitempty"`
	ImpactedMarkers []*OrderTrackingImpactedMarker `json:"impacted_markers" url:"impacted_markers"`
	// ℹ️ This enum is non-exhaustive.
	Source EtaUpdateSource `json:"source" url:"source"`
...
func (o *OrderTrackingUpdate) GetCreatedAt() time.Time {
	if o == nil {
		return time.Time{}
	}
	return o.CreatedAt
...
func (o *OrderTrackingUpdate) GetReason() *string {
	if o == nil {
		return nil
	}
	return o.Reason
...
func (o *OrderTrackingUpdate) GetRevisedEstimate() *time.Time {
	if o == nil {
		return nil
	}
	return o.RevisedEstimate
}

func (o *OrderTrackingUpdate) GetImpactedMarkers() []*OrderTrackingImpactedMarker {
	if o == nil {
		return nil
	}
	return o.ImpactedMarkers
}

func (o *OrderTrackingUpdate) GetSource() EtaUpdateSource {
	if o == nil {
		return ""
	}
	return o.Source
...
func (o *OrderTrackingUpdate) GetExtraProperties() map[string]interface{} {
	if o == nil {
		return nil
	}
	return o.extraProperties
...
func (o *OrderTrackingUpdate) require(field *big.Int) {
	if o.explicitFields == nil {
		o.explicitFields = big.NewInt(0)
	}
	o.explicitFields.Or(o.explicitFields, field)
...
// SetCreatedAt sets the CreatedAt field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingUpdate) SetCreatedAt(createdAt time.Time) {
	o.CreatedAt = createdAt
	o.require(orderTrackingUpdateFieldCreatedAt)
}

// SetReason sets the Reason field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingUpdate) SetReason(reason *string) {
	o.Reason = reason
	o.require(orderTrackingUpdateFieldReason)
}

// SetRevisedEstimate sets the RevisedEstimate field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingUpdate) SetRevisedEstimate(revisedEstimate *time.Time) {
	o.RevisedEstimate = revisedEstimate
	o.require(orderTrackingUpdateFieldRevisedEstimate)
}

// SetImpactedMarkers sets the ImpactedMarkers field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingUpdate) SetImpactedMarkers(impactedMarkers []*OrderTrackingImpactedMarker) {
	o.ImpactedMarkers = impactedMarkers
	o.require(orderTrackingUpdateFieldImpactedMarkers)
}

// SetSource sets the Source field and marks it as non-optional;
// this prevents an empty or null value for this field from being omitted during serialization.
func (o *OrderTrackingUpdate) SetSource(source EtaUpdateSource) {
	o.Source = source
	o.require(orderTrackingUpdateFieldSource)
}

func (o *OrderTrackingUpdate) UnmarshalJSON(data []byte) error {
	type embed OrderTrackingUpdate
	var unmarshaler = struct {
		embed
		CreatedAt       *internal.DateTime `json:"created_at"`
		RevisedEstimate *internal.DateTime `json:"revised_estimate,omitempty"`
	}{
		embed: embed(*o),
	}
	if err := json.Unmarshal(data, &unmarshaler); err != nil {
	...
	*o = OrderTrackingUpdate(unmarshaler.embed)
	o.CreatedAt = unmarshaler.CreatedAt.Time()
	o.RevisedEstimate = unmarshaler.RevisedEstimate.TimePtr()
	extraProperties, err := internal.ExtractExtraProperties(data, *o)
	if err != nil {
		return err
	}
...
func (o *OrderTrackingUpdate) MarshalJSON() ([]byte, error) {
	type embed OrderTrackingUpdate
	var marshaler = struct {
		embed
		CreatedAt       *internal.DateTime `json:"created_at"`
		...
		RevisedEstimate: internal.NewOptionalDateTime(o.RevisedEstimate),
	}
	explicitMarshaler := internal.HandleExplicitFields(marshaler, o.explicitFields)
	return json.Marshal(explicitMarshaler)
}

func (o *OrderTrackingUpdate) String() string {
	if o == nil {
		return "<nil>"
	}
	if len(o.rawJSON) > 0 {
