...
func (r *RawClient) Get(
...
) (*core.Response[*junctiongo.ClientFacingMealResponse], error) {
	...
	var response *junctiongo.ClientFacingMealResponse
	...
	return &core.Response[*junctiongo.ClientFacingMealResponse]{
