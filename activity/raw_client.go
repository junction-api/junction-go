...
func (r *RawClient) Get(
...
) (*core.Response[*junctiongo.ClientActivityResponse], error) {
	...
	var response *junctiongo.ClientActivityResponse
	...
	return &core.Response[*junctiongo.ClientActivityResponse]{
...
func (r *RawClient) GetRaw(
	...
	opts ...option.RequestOption,
) (*core.Response[*junctiongo.RawActivityResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *junctiongo.RawActivityResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*junctiongo.RawActivityResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
