...
func (r *RawClient) Get(
...
) (*core.Response[*junctiongo.ClientFacingProfile], error) {
	...
	var response *junctiongo.ClientFacingProfile
	...
	return &core.Response[*junctiongo.ClientFacingProfile]{
...
func (r *RawClient) GetRaw(
	...
	opts ...option.RequestOption,
) (*core.Response[*junctiongo.RawProfile], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *junctiongo.RawProfile
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*junctiongo.RawProfile]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
