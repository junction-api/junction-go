...
func (r *RawClient) GetTeamLabAccounts(
...
) (*core.Response[*junctiongo.GetTeamLabAccountsResponse], error) {
	...
	var response *junctiongo.GetTeamLabAccountsResponse
	...
	return &core.Response[*junctiongo.GetTeamLabAccountsResponse]{
