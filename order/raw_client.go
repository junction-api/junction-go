...
func (r *RawClient) ResendEvents(
...
) (*core.Response[*junctiongo.ResendWebhookResponse], error) {
	...
	var response *junctiongo.ResendWebhookResponse
	...
	return &core.Response[*junctiongo.ResendWebhookResponse]{
