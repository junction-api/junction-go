...
type SourceLink struct {
	...
	// ℹ️ This enum is non-exhaustive.
	AuthType       *SourceAuthType `json:"auth_type,omitempty" url:"auth_type,omitempty"`
	FormComponents map[string]any  `json:"form_components,omitempty" url:"form_components,omitempty"`
...
func (s *SourceLink) GetFormComponents() map[string]any {
	if s == nil {
		return nil
	}
...
// this prevents an empty or null value for this field from being omitted during serialization.
func (s *SourceLink) SetFormComponents(formComponents map[string]any) {
