...
func (r *RawClient) Get(
...
) (*core.Response[*junctiongo.MenstrualCycleResponse], error) {
	...
	var response *junctiongo.MenstrualCycleResponse
	...
	return &core.Response[*junctiongo.MenstrualCycleResponse]{
