...
func (r *RawClient) Get(
...
) (*core.Response[*junctiongo.ClientWorkoutResponse], error) {
	...
	var response *junctiongo.ClientWorkoutResponse
	...
	return &core.Response[*junctiongo.ClientWorkoutResponse]{
...
func (r *RawClient) GetRaw(
	...
	opts ...option.RequestOption,
) (*core.Response[*junctiongo.RawWorkoutResponse], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *junctiongo.RawWorkoutResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*junctiongo.RawWorkoutResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
...
func (r *RawClient) GetByWorkoutId(
	...
	opts ...option.RequestOption,
) (*core.Response[*junctiongo.ClientFacingStream], error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		r.baseURL,
	...
	var response *junctiongo.ClientFacingStream
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*junctiongo.ClientFacingStream]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
