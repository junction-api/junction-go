...
func (r *RawClient) GetAll(
...
) (*core.Response[[]*junctiongo.ClientFacingProviderDetailed], error) {
	...
	var response []*junctiongo.ClientFacingProviderDetailed
	...
	return &core.Response[[]*junctiongo.ClientFacingProviderDetailed]{
